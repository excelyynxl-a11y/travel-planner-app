          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8">
                Create itineraries, organise destinations and 
                share your travel plans all in one.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <AuthButton
                  ...
                  className="w-full sm:w-auto bg-black text-white hover:bg-gray-800 
                            px-6 py-3 rounded-lg transition-colors duration-200 flex 
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Visualize your trip with interactive maps.
                  See your entire itinerary at a glance.
                </p>
              </div>

              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                <div className="w-12 h-12 rounded-full bg-amber-100 flex items-center items-center justify-center mb-4">
                  <svg
                ...
                <p className="text-gray-600">
                  ...
                  Never miss a beat with structured planning.
                </p>
              </div>
        ...
        <section className="py-16 md:py-24 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
              Join travelers who plan better trips with TripPlanner.
            </p>
            <AuthButton
              isLoggedIn={isLoggedIn}
